...
class HTTPRelayServer(Thread):
    ...
    class HTTPHandler(http.server.SimpleHTTPRequestHandler):
        ...
        def do_attack(self):
            from comm.ntlmrelayx.attacks.smbattack import SMBAttack
            clientThread = SMBAttack(self.server.config, self.client.session, self.authUser)
            clientThread.start()
